...
const MyAppoinment = () => {
  ...
  const slotDateFormat = (slotDate) => {
    ...
    // Log to debug
    console.log("slotDate:", slotDate); // Check the slotDate value
    console.log("dateArray:", dateArray); // Check the split result
  
    const monthIndex = Number(dateArray[1]);
    
    // Log the month index to ensure it's being parsed correctly
    ...
    return "Invalid Date"; // Return this if the month is invalid
  }
