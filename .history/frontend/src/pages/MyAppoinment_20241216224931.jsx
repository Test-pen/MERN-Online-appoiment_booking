...
const MyAppointments = () => {
  ...
  // State to check if payment is completed
        ...
        {appointments.map((item, index) => (
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:gap-6 py-2 border-b' key={index}>
            ...
            <div className='flex flex-col gap-2 justify-end'>
              {!item.cancelled && !paymentCompleted && (
                <button 
              ...
              {paymentCompleted && !item.cancelled && (
                <button className='sm:min-w-48 py-2 border bg-green-700 text-white rounded'>
                  Payment Completed
                </button>
              )}
