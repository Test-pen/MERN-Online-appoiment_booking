  ...
  return (
    <form className='min-h-[80vh] flex items-center'>
      <div className='fllex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'> 
        ...
        <button className='bg-primary text-white w-full py-2 rounded-md text-base hover:translate-y-[2px] transition-all duration-10'>{state==='Sign Up'? "Create Account" : "Login"}</button>
        {
          state ==='Sign Up'
